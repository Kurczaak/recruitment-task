...
class _$ResultTearOff {
  ...
  ErrorDetails<T> error<T>(String? message, {int? code}) {
...
class _$Data<T> implements Data<T> {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Data<T>);
  }
...
abstract class ErrorDetails<T> implements Result<T> {
  const factory ErrorDetails(String? message, {int? code}) = _$ErrorDetails<T>;
